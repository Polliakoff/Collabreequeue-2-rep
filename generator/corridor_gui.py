...
WIDTH_M     = 250                             # ширина коридора (от борта до борта) в метрах
CLEAR_M0    = 50                              # стартовый безопасный зазор до льда (м), будет уменьшаться
...
MIN_SPAN_KM = 10                              # минимальная ширина/высота случайного ROI (км)
MAX_SPAN_KM = 5                              # максимальная ширина/высота случайного ROI (км)
